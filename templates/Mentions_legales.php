    ...
    <section class="blockcentral ">
        ...
        <b>Prestations et Services&nbsp;:</b> <a href="http://campus.academy.portfolio.gregoire.delangenhagen">http://campus.academy.portfolio.gregoire.delangenhagen</a> met à disposition des Clients&nbsp;:</p>

        <p><b>Contenu&nbsp;:</b>&nbsp;Ensemble des éléments constituants l’information présente sur le Site, notamment textes – images – vidéos.</p>

        <p><b>Informations clients&nbsp;:</b> Ci après dénommé «&nbsp;Information (s)&nbsp;» qui correspondent à l’ensemble des données personnelles susceptibles d’être détenues par <a href="http://campus.academy.portfolio.gregoire.delangenhagen">http://campus.academy.portfolio.gregoire.delangenhagen</a> pour la gestion de votre compte, de la gestion de la relation client et à des fins d’analyses et de statistiques.</p>
        ...
        <strong>Délégué à la protection des données</strong> : grégoire De Langenhagen – greg_degaine@hotmail.fr<br>
        </p>
        ...
        <p>Le site internet&nbsp;<a href="http://campus.academy.portfolio.gregoire.delangenhagen">http://campus.academy.portfolio.gregoire.delangenhagen</a>&nbsp;a pour objet de fournir une information concernant l’ensemble des activités de la société.
        ...
        Le site <a href="http://campus.academy.portfolio.gregoire.delangenhagen">http://campus.academy.portfolio.gregoire.delangenhagen</a> est hébergé chez un prestataire sur le territoire de l’Union Européenne conformément aux dispositions du Règlement Général sur la Protection des Données (RGPD&nbsp;: n° 2016-679)</p>
        ...
        Toute reproduction, représentation, modification, publication, adaptation de tout ou partie des éléments du site, quel que soit le moyen ou le procédé utilisé, est interdite, sauf autorisation écrite préalable de : <a href="http://campus.academy.portfolio.gregoire.delangenhagen">http://campus.academy.portfolio.gregoire.delangenhagen</a>.</p>
        ...
        <p>Pour les Données Personnelles collectées dans le cadre de la création du compte personnel de l’Utilisateur et de sa navigation sur le Site, le responsable du traitement des Données Personnelles est : grégoire De Langenhagen. <a href="http://campus.academy.portfolio.gregoire.delangenhagen">http://campus.academy.portfolio.gregoire.delangenhagen</a>est représenté par grégoire De Langenhagen, son représentant légal</p>
        ...
        &nbsp;
        <p><a href="http://campus.academy.portfolio.gregoire.delangenhagen">http://campus.academy.portfolio.gregoire.delangenhagen</a> est susceptible de traiter tout ou partie des données : </p>
        ...
        &nbsp;
        <li>pour mener des enquêtes de satisfaction facultatives sur <a href="http://campus.academy.portfolio.gregoire.delangenhagen">http://campus.academy.portfolio.gregoire.delangenhagen</a> : adresse email </li>
        <li>pour mener des campagnes de communication (sms, mail) : numéro de téléphone, adresse email</li>


        </ul>

        <p><a href="http://campus.academy.portfolio.gregoire.delangenhagen">http://campus.academy.portfolio.gregoire.delangenhagen</a> ne commercialise pas vos données personnelles qui sont donc uniquement utilisées par nécessité ou à des fins statistiques et d’analyses.</p>
        &nbsp;
        <h3>7.3 Droit d’accès, de rectification et d’opposition</h3>
        &nbsp;
        <p>
        Conformément à la réglementation européenne en vigueur, les Utilisateurs de <a href="http://campus.academy.portfolio.gregoire.delangenhagen">http://campus.academy.portfolio.gregoire.delangenhagen</a> disposent des droits suivants : </p>
        &nbsp;<ul>
        ...
        &nbsp;
        <li>droit de définir le sort des données des Utilisateurs après leur mort et de choisir à qui <a href="http://campus.academy.portfolio.gregoire.delangenhagen">http://campus.academy.portfolio.gregoire.delangenhagen</a> devra communiquer (ou non) ses données à un tiers qu’ils aura préalablement désigné</li>
        &nbsp;</ul>
        ...
        &nbsp;
        <p>
        Lors du traitement des Données Personnelles, <a href="http://campus.academy.portfolio.gregoire.delangenhagen">http://campus.academy.portfolio.gregoire.delangenhagen</a>prend toutes les mesures raisonnables visant à les protéger contre toute perte, utilisation détournée, accès non autorisé, divulgation, altération ou destruction.</p>
        &nbsp;
        ...
        &nbsp;<p>
         ...
         <p>
        Tout litige en relation avec l’utilisation du site&nbsp;<a href="http://campus.academy.portfolio.gregoire.delangenhagen">http://campus.academy.portfolio.gregoire.delangenhagen</a>&nbsp;est soumis au droit français. 
